  ...
  return (
    <div className="relative min-h-screen bg-[#030014] text-zinc-100 flex flex-col justify-between selection:bg-violet-500/30 selection:text-violet-200">
      ...
      <header className="sticky top-0 z-50 w-full border-b border-white/5 bg-[#030014]/70 backdrop-blur-lg">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden absolute top-16 left-0 w-full border-b border-white/5 bg-[#030014]/95 backdrop-blur-xl px-6 py-6 flex flex-col gap-5 shadow-2xl">
            <a href="#features" onClick={() => setMobileMenuOpen(false)} className="text-lg font-medium text-zinc-300 hover:text-white transition-colors">Features</a>
            <a href="#example-cards" onClick={() => setMobileMenuOpen(false)} className="text-lg font-medium text-zinc-300 hover:text-white transition-colors">Example Cards</a>
            <a href="#how-it-works" onClick={() => setMobileMenuOpen(false)} className="text-lg font-medium text-zinc-300 hover:text-white transition-colors">How It Works</a>
            <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-lg font-medium text-zinc-300 hover:text-white flex items-center gap-2">
      ...
      <main className="flex-1">
        <section className="max-w-7xl mx-auto px-6 pt-16 pb-28 flex flex-col lg:flex-row items-center gap-16 relative">
          <div className="flex-1 flex flex-col items-center lg:items-start text-center lg:text-left gap-8">
            ...
            <p className="text-zinc-400 text-lg md:text-xl max-w-xl leading-relaxed">
              Create gorgeous, dynamically generated SVG cards representing your commits, stars, streaks, and repository stats. Personalize with stunning presets and enrich your profile README.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
              <Link href="/dashboard" className="px-8 py-4 rounded-xl font-bold bg-white text-zinc-950 hover:bg-zinc-200 hover:scale-[1.02] active:scale-[0.98] transition-all shadow-xl shadow-white/5 flex items-center justify-center gap-2 group" id="hero-cta-dashboard">
                <span>Customize Your Cards</span>
                <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </Link>
              <a href="#how-it-works" className="px-8 py-4 rounded-xl font-bold border border-white/10 bg-white/5 hover:bg-white/10 hover:border-white/20 hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2.5" id="hero-cta-howitworks">
          ...
          <div className="flex-1 w-full max-w-md lg:max-w-none relative flex flex-col items-center">
            ...
            <div className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 rounded-full ${currentHeroTheme.glowClass} blur-3xl transition-colors duration-500 pointer-events-none`} />
            ...
            <div className={`w-full max-w-lg glass-card rounded-2xl p-6.5 relative overflow-hidden group border ${currentHeroTheme.borderClass} animate-float`}>
              ...
              <div className="flex items-center justify-between pb-5 border-b border-white/5">
                ...
                {showRank && (
                  <div className={`px-3 py-1 rounded-lg border font-black text-sm tracking-wide ${currentHeroTheme.badgeClass}`}>
                    A+ RANK
                  </div>
                )}
              </div>
              ...
              <div className="py-6 grid grid-cols-3 gap-4 border-b border-white/5">
                <div>
                  <p className="text-zinc-500 text-[10px] uppercase tracking-wider font-extrabold font-mono">Repositories</p>
                  <p className="text-2xl font-black text-white mt-0.5">142</p>
                </div>
                <div>
                  <p className="text-zinc-500 text-[10px] uppercase tracking-wider font-extrabold font-mono">Followers</p>
                  <p className="text-2xl font-black text-white mt-0.5">8.9k</p>
                </div>
                <div>
                  <p className="text-zinc-500 text-[10px] uppercase tracking-wider font-extrabold font-mono">Total Stars</p>
              ...
              <div className="py-5 border-b border-white/5">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className={`text-[10px] font-bold ${currentHeroTheme.accentText}`}>86 commits this month</span>
                </div>
                ...
                <div className="h-6.5 flex rounded-lg overflow-hidden bg-white/5 p-1 border border-white/5">
                  ...
                  <div className="bg-zinc-600 h-full rounded-r-md transition-all duration-500" style={{ width: '8%' }} title="Other (8%)" />
                </div>
                <div className="flex justify-between items-center text-[10px] text-zinc-500 mt-2 font-mono">
                  <span className="flex items-center gap-1"><span className="w-1.5 h-1.5 rounded-full bg-violet-500 block" /> TypeScript</span>
                  <span className="flex items-center gap-1"><span className="w-1.5 h-1.5 rounded-full bg-emerald-500 block" /> Rust</span>
                  <span className="flex items-center gap-1"><span className="w-1.5 h-1.5 rounded-full bg-amber-500 block" /> Go</span>
                  <span className="flex items-center gap-1"><span className="w-1.5 h-1.5 rounded-full bg-zinc-500 block" /> Other</span>
                </div>
              </div>
        ...
        {/* Features Section */}
        <section id="features" className="border-t border-white/5 bg-white/[0.005] py-28 relative scroll-mt-16">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center max-w-2xl mx-auto mb-20">
              ...
              <p className="text-zinc-400 text-base sm:text-lg">
                Everything you need to turn your profile README into a dynamic resume that tells your unique developer story.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="glass-card rounded-2xl p-8 flex flex-col gap-5 hover:border-violet-500/30 group">
                ...
                <p className="text-zinc-400 text-sm leading-relaxed">
                  Real-time generated vector badges that require zero hosting. Simply reference the API endpoint in your Markdown and let it handle the rest automatically.
                </p>
              </div>
              ...
              <div className="glass-card rounded-2xl p-8 flex flex-col gap-5 hover:border-pink-500/30 group">
                ...
                <p className="text-zinc-400 text-sm leading-relaxed">
                  Choose from custom built-in themes like Neon Amethyst, Synthwave, or Nord, or write your own custom parameters using direct Hex/HSL queries.
                </p>
              </div>
              ...
              <div className="glass-card rounded-2xl p-8 flex flex-col gap-5 hover:border-indigo-500/30 group">
                ...
                <p className="text-zinc-400 text-sm leading-relaxed">
                  Your token security is paramount. Your authorization is kept safe and clean. We never track or store individual repository details to database schemas.
                </p>
              </div>
              ...
              <div className="glass-card rounded-2xl p-8 flex flex-col gap-5 hover:border-emerald-500/30 group">
                ...
                <p className="text-zinc-400 text-sm leading-relaxed">
                  Generate pie charts, progress blocks, or horizontal metrics representing your actual codebase volume. Filter out forks and system files automatically.
                </p>
              </div>
              ...
              <div className="glass-card rounded-2xl p-8 flex flex-col gap-5 hover:border-amber-500/30 group">
                ...
                <p className="text-zinc-400 text-sm leading-relaxed">
                  Track and display your consistency streaks without relying on external widgets. Display current streak, peak achievements, and overall records.
                </p>
              </div>
              ...
              <div className="glass-card rounded-2xl p-8 flex flex-col gap-5 hover:border-cyan-500/30 group">
                ...
                <p className="text-zinc-400 text-sm leading-relaxed">
                  Cards are distributed using Vercel/Cloudflare Edge networks. Response times average 12-25 milliseconds, guaranteeing your profile README loads instantly.
                </p>
              </div>
            </div>
          </div>
        ...
        <section id="example-cards" className="border-t border-white/5 py-28 relative scroll-mt-16">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center max-w-2xl mx-auto mb-16">
              ...
              <p className="text-zinc-400 text-base sm:text-lg">
                Toggle through different widget styles and colors to find the exact format for your profile page.
              </p>
            </div>
                    ...
                    {activeTab === "stats" && (
                      <div className={`glass-card p-6.5 rounded-2xl border ${currentExampleTheme.borderClass}`}>
                        <div className="flex items-center justify-between pb-5 border-b border-white/5">
                          ...
                          <span className={`px-2.5 py-0.5 rounded-md border text-xs font-black tracking-wide ${currentExampleTheme.badgeClass}`}>
                            RANK A
                          </span>
                        </div>
                        ...
                        <div className="py-5 flex flex-col gap-4">
                          ...
                          <div className="flex flex-col gap-2">
                            ...
                            <div className="w-full bg-white/5 h-2 rounded-full overflow-hidden">
                              <div className={`bg-gradient-to-r ${currentExampleTheme.barColor} h-full rounded-full`} style={{ width: '64.5%' }} />
                            </div>
                          </div>
                          ...
                          <div className="flex flex-col gap-2">
                            ...
                            <div className="w-full bg-white/5 h-2 rounded-full overflow-hidden">
                              <div className="bg-emerald-500 h-full rounded-full" style={{ width: '22.1%' }} />
                            </div>
                          </div>
                          ...
                          <div className="flex flex-col gap-2">
                            ...
                            <div className="w-full bg-white/5 h-2 rounded-full overflow-hidden">
                              <div className="bg-amber-500 h-full rounded-full" style={{ width: '8.4%' }} />
                            </div>
                          </div>
                        </div>
                      ...
                      <div className={`glass-card p-6.5 rounded-2xl border ${currentExampleTheme.borderClass}`}>
                        ...
                        <div className="py-6 grid grid-cols-3 gap-3 text-center">
                          <div className="p-2 border border-white/5 bg-white/[0.01] rounded-xl">
                            <p className="text-[10px] text-zinc-500 uppercase font-bold font-mono">Current Streak</p>
                            <p className={`text-2xl font-black ${currentExampleTheme.accentText} mt-1`}>18</p>
                            <p className="text-[9px] text-zinc-500 mt-0.5">Days</p>
                          </div>
                          <div className="p-2 border border-white/5 bg-white/[0.01] rounded-xl">
                            <p className="text-[10px] text-zinc-500 uppercase font-bold font-mono">Longest Streak</p>
                            <p className="text-2xl font-black text-white mt-1">42</p>
                            <p className="text-[9px] text-zinc-500 mt-0.5">Days (Jul 2026)</p>
                          </div>
                          <div className="p-2 border border-white/5 bg-white/[0.01] rounded-xl">
                            <p className="text-[10px] text-zinc-500 uppercase font-bold font-mono">Total Commits</p>
                      ...
                      <div className={`glass-card p-6.5 rounded-2xl border ${currentExampleTheme.borderClass}`}>
                        <div className="flex items-center justify-between pb-4 border-b border-white/5">
                          <div className="flex items-center gap-2 text-white">
                            ...
                            <h5 className="font-extrabold text-sm tracking-tight">octocat/hello-world</h5>
                          </div>
                        ...
                        <p className="py-4 text-xs text-zinc-300 leading-relaxed">
                          A simple demonstration project that displays welcome messages and sets standard greetings in multiple localizations. Beautifully configured container models.
                        </p>

                        <div className="pt-4 border-t border-white/5 flex items-center justify-between text-[11px] text-zinc-500 font-mono">
                          <div className="flex items-center gap-4">
                            <span className="flex items-center gap-1.5"><span className={`w-2.5 h-2.5 rounded-full ${currentExampleTheme.dotColor}`} /> TypeScript</span>
        ...
        <section id="how-it-works" className="border-t border-white/5 bg-white/[0.005] py-28 relative scroll-mt-16">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center max-w-2xl mx-auto mb-20">
              <h2 className="text-3xl sm:text-4xl font-extrabold tracking-tight text-white mb-4">
              ...
              <p className="text-zinc-400 text-base sm:text-lg">
                Setting up GitProfileStats is straightforward and takes less than a minute. No coding required.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="glass-card rounded-2xl p-6.5 border border-white/5 relative flex flex-col gap-4">
                ...
                <div>
                  ...
                  <p className="text-zinc-400 text-xs leading-relaxed mb-4">
                    Input your public GitHub username in our quick search helper to load initial metrics.
                  </p>
              ...
              <div className="glass-card rounded-2xl p-6.5 border border-white/5 relative flex flex-col gap-4">
                ...
                <div>
                  ...
                  <p className="text-zinc-400 text-xs leading-relaxed">
                    Select layouts (Stats, Streak, Languages) and choose preconfigured themes or custom color inputs to match your README layout style.
                  </p>
                </div>
              ...
              <div className="glass-card rounded-2xl p-6.5 border border-white/5 relative flex flex-col gap-4">
                ...
                <div>
                  ...
                  <p className="text-zinc-400 text-xs leading-relaxed">
                    Paste the Markdown code into your profile description repository files, save, and enjoy your beautiful automatic stats widget!
                  </p>
                </div>
      ...
      <footer className="border-t border-white/5 py-12 relative bg-black/25">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex flex-wrap justify-center gap-8 text-xs font-semibold text-zinc-400">
            <a href="#features" className="hover:text-white transition-colors duration-200">Features</a>
            <a href="#example-cards" className="hover:text-white transition-colors duration-200">Examples</a>
            <a href="#how-it-works" className="hover:text-white transition-colors duration-200">How It Works</a>
